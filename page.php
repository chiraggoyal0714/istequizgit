...
if($status == 0){
    ...
    <head>
        ...
        <style>
            ...
            body{
                background: url(<?php echo 'images/bg/'.$l.'.jpg'; ?>) no-repeat center center fixed;
    ...
    <div class="container" style="margin-top: 20%">
        <div class="col-md-8 col-md-offset-1">
            <h1 style="margin-top: -25%" >Level <?php echo ($l); ?></h1>
            <img src="images/ques/<?php echo $cimgsrc ?>"  width="720px" height="420px" class="img-responsive center-block" alt="Responsive image">
            <br>
