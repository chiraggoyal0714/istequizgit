...
$db=getDB();
$stmt=$db->prepare("SELECT username,question_id,college from users WHERE status = 0 ORDER BY question_id DESC,create_time ASC LIMIT 25");
$stmt->execute();
$login = $stmt->fetchall();
$count = count($login);
...
<p>
    rfiifijdjfbfiybbeifbibfiribubuubcububuBUBUDBUBUBububbuoboboubo
</p>
